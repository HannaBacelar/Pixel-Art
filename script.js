function criaPaletaDeCores() {
  const capturaClassColor = document.getElementsByClassName('color');
...
function criaColunas() {
  const colunaCapturada = document.querySelector('#pixel-board');
  for (let i = 0; i <= 4; i += 1) {
...
const capturaCorPaleta = document.getElementsByClassName('color');
...
const capturaClassSelected = document.getElementsByClassName('selected');
